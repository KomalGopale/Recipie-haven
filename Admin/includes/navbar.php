<?php 
session_start(); 
$username = isset($_SESSION['email']) ? $_SESSION['email'] : 'User';
?>
...
<li class="nav-item">
    ...
    <div id="collapseRecipie" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="add_recipie.php">Add New</a>
            <a class="collapse-item" href="recipie.php">All Recipies</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseCategory" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="category.php">All Categories</a>
        </div>
    </div>
</li>
